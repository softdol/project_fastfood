...
public class Mobile_Pay extends JFrame{
	...
	JLabel label1 = new JLabel("»ç¿ëÇÏ½Ç ÄíÆùÀÇ ¹ÙÄÚµå¸¦");
	JLabel label2 = new JLabel("¾Æ·¡ ¹ÙÄÚµå ¸®´õ±â¿¡ ½ºÄµÇØÁÖ¼¼¿ä.");
