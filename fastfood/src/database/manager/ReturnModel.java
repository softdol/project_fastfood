...
public class ReturnModel {
	 ...
	 */
	public static ArrayList<SubCategory> categorySubList(String sql, ArrayList<PsList> psList){
	...
	public static ArrayList<String> selStringList (String sql, ArrayList<PsList> psList) {		
	...
	public static ArrayList<Order> selOrderList (String sql, ArrayList<PsList> psList) {		
